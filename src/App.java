...
/**
 * This tic tac is programmed by Biswajit Shaw.
 * Following the tutorial available on https://www.delftstack.com/howto/java/tic-tac-toe-java-gui/
 */
...
public class App extends JPanel {
    ...
    public boolean checkForWinner() {
        return checkAllRows() || checkAllColumns() || checkAllRows();
    }
    ...
    public boolean checkAllRows() {
        ...
        for (int j = 0; j < 3; j++) {
            if (jButtons[i].getText().equals(jButtons[i + 1].getText())
                    && jButtons[i].getText().equals(jButtons[i + 2].getText()) && !jButtons[i].getText().equals("")) {
                return true;
            }
            i++;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        jFrame.getContentPane().add(new App());
